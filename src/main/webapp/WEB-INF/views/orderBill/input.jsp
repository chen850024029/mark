		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					...
					<td class="ui_text_lt">
						<select name="supplier.id" class="ui_select03">
							...
							<c:forEach items="${suppliers}" var="supplier">
								<option value="${supplier.id}" ${entity.supplier.id==supplier.id?"selected":""}>${supplier.name}</option>
							</c:forEach>
						</select>
					</td>
				</tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
						&nbsp;<input type="button" value="确定保存" class="ui_input_btn01" id="pid" data-obj="orderBill"/>
