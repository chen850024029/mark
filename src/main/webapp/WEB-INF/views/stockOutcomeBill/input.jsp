...
<script type="text/javascript" src="/js/commonAll.js"></script>
    <script type="text/javascript">
      $(function () {
          ...
          //小计
          $("[tag=salePrice],[tag=number]").blur(function () {
             var currentTr = $(this).closest("tr");
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					...
					<td class="ui_text_lt">
						<select name="client.id" class="ui_select03">
							...
							<c:forEach items="${clients}" var="client">
								<option value="${client.id}" ${entity.client.id==client.id?"selected":""}>${client.name}</option>
							</c:forEach>
						</select>
					</td>
				</tr>
                            ...
                            <c:if test="${entity.id==null}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" tag="pid" value=""/>
                                    </td>

                                    <td><span tag="brand"></span></td>
                                    <td><input tag="salePrice" type="number" value=""
                                               class="ui_input_txt02"/></td>
                                    <td><input tag="number" type="number" value=""
                                               class="ui_input_txt02"/></td>
                                    <td><span tag="amount"></span></td>
                                    <td><input tag="remark" value=""
                                               class="ui_input_txt02"/></td>
                                    <td>
				...
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
						&nbsp;<input type="button" value="确定保存" class="ui_input_btn01" id="pid" data-obj="stockOutcomeBill"/>
